...
// lib/xml-beautifier.ts
var _ = require_lodash();
var splitOnTags = /* @__PURE__ */ __name((str) => str.split(/(<\/?[^>]+>)/g).filter((line) => line.trim() !== ""), "splitOnTags");
var isTag = /* @__PURE__ */ __name((str) => /<[^>!]+>/.test(str), "isTag");
var isXMLDeclaration = /* @__PURE__ */ __name((str) => /<\?[^?>]+\?>/.test(str), "isXMLDeclaration");
var isClosingTag = /* @__PURE__ */ __name((str) => /<\/+[^>]+>/.test(str), "isClosingTag");
var isSelfClosingTag = /* @__PURE__ */ __name((str) => /<[^>]+\/>/.test(str), "isSelfClosingTag");
var isOpeningTag = /* @__PURE__ */ __name((str) => isTag(str) && !isClosingTag(str) && !isSelfClosingTag(str) && !isXMLDeclaration(str), "isOpeningTag");
...
var ENodeTypes;
(function(ENodeTypes3) {
  ENodeTypes3["opencdata"] = "opencdata";
  ENodeTypes3["sgmldeclaration"] = "sgmldeclaration";
  ENodeTypes3["doctype"] = "doctype";
  ENodeTypes3["comment"] = "comment";
  ENodeTypes3["closecdata"] = "closecdata";
  ENodeTypes3["processinginstruction"] = "processinginstruction";
  ENodeTypes3["opennamespace"] = "opennamespace";
  ENodeTypes3["opentag"] = "opentag";
  ENodeTypes3["extractedrawtag"] = "extractedrawtag";
  ENodeTypes3["closetag"] = "closetag";
  ENodeTypes3["closenamespace"] = "closenamespace";
  ENodeTypes3["cdata"] = "cdata";
  ENodeTypes3["script"] = "script";
  ENodeTypes3["opentagstart"] = "opentagstart";
  ENodeTypes3["attribute"] = "attribute";
  ENodeTypes3["text"] = "text";
})(ENodeTypes || (ENodeTypes = {}));
var EventTypes = NodeTypes.concat(["ready", "end", "error"]);
var CDATA = "[CDATA[";
var DOCTYPE = "DOCTYPE";
...
sax.ENTITIES = import_lodash.default.clone(SAXEntities_default);
...
function fix_indent(xml) {
  return xml_beautifier_default(xml, 2);
}
...
var SAXParser = class extends import_stream.EventEmitter {
...
var SAXStream = class extends import_stream2.Transform {
