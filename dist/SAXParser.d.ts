...
export declare type NodeType = 'onopencdata' | 'onsgmldeclaration' | 'ondoctype' | 'oncomment' | 'onclosecdata' | 'onprocessinginstruction' | 'onopennamespace' | 'onopentag' | 'onextractedrawtag' | 'onclosetag' | 'onclosenamespace' | 'oncdata' | 'onscript' | 'onopentagstart' | 'onattribute' | 'ontext';
export declare type EventType = NodeType | 'onready' | 'onend' | 'onerror';
