...
var ENodeTypes;
(function(ENodeTypes2) {
  ENodeTypes2["opencdata"] = "opencdata";
  ENodeTypes2["sgmldeclaration"] = "sgmldeclaration";
  ENodeTypes2["doctype"] = "doctype";
  ENodeTypes2["comment"] = "comment";
  ENodeTypes2["closecdata"] = "closecdata";
  ENodeTypes2["processinginstruction"] = "processinginstruction";
  ENodeTypes2["opennamespace"] = "opennamespace";
  ENodeTypes2["opentag"] = "opentag";
  ENodeTypes2["extractedrawtag"] = "extractedrawtag";
  ENodeTypes2["closetag"] = "closetag";
  ENodeTypes2["closenamespace"] = "closenamespace";
  ENodeTypes2["cdata"] = "cdata";
  ENodeTypes2["script"] = "script";
  ENodeTypes2["opentagstart"] = "opentagstart";
  ENodeTypes2["attribute"] = "attribute";
  ENodeTypes2["text"] = "text";
})(ENodeTypes || (ENodeTypes = {}));
